...
interface ProfileSettings {
  ...
  about_education_primary_college: string | null;
  about_education_primary_cgpa: string | null;
  about_education_primary_start: string | null;
  about_education_primary_end: string | null;
  about_education_secondary_college: string | null;
  about_education_secondary_cgpa: string | null;
  about_education_secondary_start: string | null;
  about_education_secondary_end: string | null;
