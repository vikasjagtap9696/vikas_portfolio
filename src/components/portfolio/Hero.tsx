...
export function Hero() {
  ...
  return (
    <section id="home" className="hero">
      {/* Admin Edit Buttons (Inside section for better interaction, but high z-index) */}
      {user && (
        <div style={{
          position: "absolute",
          top: "8rem",
          ...
          <button className="section-edit-btn" style={{ pointerEvents: "auto" }} onClick={() => setOpenDialog("heroText")}>
          ...
          <button className="section-edit-btn" style={{ pointerEvents: "auto" }} onClick={() => setOpenDialog("heroStats")}>
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
              <path d="M11 4H4a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-7"></path>
              <path d="M18.5 2.5a2.121 2.121 0 0 1 3 3L12 15l-4 1 1-4 9.5-9.5z"></path>
            </svg>
          ...
          <button className="section-edit-btn" style={{ pointerEvents: "auto" }} onClick={() => setOpenDialog("profilePhoto")}>
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
              <path d="M11 4H4a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-7"></path>
              <path d="M18.5 2.5a2.121 2.121 0 0 1 3 3L12 15l-4 1 1-4 9.5-9.5z"></path>
            </svg>
          ...
          <button className="section-edit-btn" style={{ pointerEvents: "auto" }} onClick={() => setOpenDialog("socialLinks")}>
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
              <path d="M11 4H4a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-7"></path>
              <path d="M18.5 2.5a2.121 2.121 0 0 1 3 3L12 15l-4 1 1-4 9.5-9.5z"></path>
            </svg>
