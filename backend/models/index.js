...
const ProfileSetting = sequelize.define('ProfileSetting', {
    ...
    about_education_primary_college: DataTypes.STRING,
    about_education_primary_cgpa: DataTypes.STRING,
    about_education_primary_start: DataTypes.STRING,
    about_education_primary_end: DataTypes.STRING,
    about_education_secondary_college: DataTypes.STRING,
    about_education_secondary_cgpa: DataTypes.STRING,
    about_education_secondary_start: DataTypes.STRING,
    about_education_secondary_end: DataTypes.STRING,
